import { obtenerMetricasComerciales } from '../utils/apiMetricasComerciales.js';

/**
 * API Endpoint: Métricas Comerciales Completas
 * 
 * GET /api/metricasComerciales
 * 
 * Query Parameters:
  ...
  try {
    ...
    if (!query.fecha_inicio || !query.fecha_fin) {
      return new Response(JSON.stringify({
        ...
        ejemplo: '/api/metricasComerciales?fecha_inicio=2024-01-01&fecha_fin=2024-12-31&sede=El%20Bosque'
      }), {
    ...
    const resultado = await obtenerMetricasComerciales({
    ...
    console.error('Error en /api/metricasComerciales:', error);
